...
| **The Quark Exponent** | NB137 | Quark window-0 exponent investigation; per-level survey; wrapping anatomy; algebraic battery; T-convergence | 0 new identities (investigation). x_eff(s/d) = 1.5866464 perfectly T-independent. Best: 2^(2/3) = p₁^{(p₂-1)/p₂} at −475 ppm, 4× over next-best. R₀ quark x ≈ ω(P₄)/p₄ = 4/7 (3.7 ppm). Bridge: (48/49)×(27/4)^{1/3}. Unified: lepton p₂^{p₂/p₂}, quark p₁^{(p₂-1)/p₂}. Exponent remains OPEN. |
