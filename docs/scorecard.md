...
> Last updated after NB137 (The Quark Exponent — factored exponent architecture discovered: both quark and lepton window-0 exponents decompose as x(R₃) = x(R₀) × cross-level, all T-independent. Quark: (4/7)(25/9) = 100/63. Lepton: (27/11)(11/9) = 3, where the intermediate 11 = ci of quark g1 crossing cancels. T-sweep verified to T=20000 with spread = 0).

## Summary

| Metric | Value |
|--------|-------|
| **Structural identities** | 277 |
| **Free parameters** | 0 |
