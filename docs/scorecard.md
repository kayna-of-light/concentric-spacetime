...
> Last updated after NB127 (The Bottom Quark — m_t/m_b = P₄/p₃ = 42 = p₁p₂p₄, charge prime removed from primorial; cross-sector bridge completes 6-quark mass table from M_Z; cascade consistency (m_t/m_c)/(m_b/m_s) ≈ p₂ = 3; b-τ check m_b/m_τ ≈ p₄/p₂ = 7/3 derived consistency; 2 identities #271-#272).

## Summary

| Metric | Value |
|--------|-------|
| **Structural identities** | 272 |
| **Free parameters** | 0 |
| **Dimensional anchors** | 1 (M_Z = 91.1876 GeV) |
| **Input** | The four primes {2, 3, 5, 7}, equivalently P₄ = 210 |
| **Genuine nulls** | 2 (#214, #215 — phase-sampling artifacts of +1 time offset) |
| **Notebooks** | 127 (NB01–NB127) |
