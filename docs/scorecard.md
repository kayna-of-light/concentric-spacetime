...
> Last updated after NB111 (The Gauge Coupling Hierarchy — ρ-corrected couplings, GUT normalization from CRT, QCD β = p₄, sin²θ_W derived via EW identity: 88σ → 2.2σ).
