...
> Last updated after NB134 (The Window-Zero Exponent — confirmed T-independent x_eff = 3.000376 ≈ p₂ for lepton intra-gen channel; cumulative pipeline T-dependence demonstrated; exponent ratio X₄_LEP/p₂ = 49/(6π)).

## Summary

| Metric | Value |
|--------|-------|
| **Structural identities** | 277 (276 established + 1 provisional) |
| **Free parameters** | 0 |
| **Dimensional anchors** | 1 (M_Z = 91.1876 GeV) |
| **Input** | The four primes {2, 3, 5, 7}, equivalently P₄ = 210 |
| **Genuine nulls** | 2 (#214, #215 — phase-sampling artifacts of +1 time offset) |
| **Notebooks** | 134 (NB01–NB134) |
