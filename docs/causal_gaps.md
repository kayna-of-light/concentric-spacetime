...
|----------|----------------|--------|
| x_q | 100/63 = 1.58730159 | Analytical form CONFIRMED (NB170 #279). Factored: (4/7)(25/9). Base 4/7 DERIVED. Cross-level 25/9 MECHANISM IDENTIFIED (NB171): transient wrapping + SS amplification ≈ p₃². Remaining: prove SS₃/SS₀ = p₃² → **GAP-20**. NB183: S² geometric origin x_q = (3/2)×(200/189) at l=2. NB187: 200/189 NOT absorbable by per-ℓ damping — confirmed as S¹ cascade mechanism |
| x_l | 3.0003758562 | DERIVED from S² Laplacian: x_lep = l(l+1)/P₁² at l=3 = 3 (NB183/186). Promoted to exact 3 (NB147). Mechanism: S² eigenvalue on innermost sphere |
...
| **GD-3** | **200/189 per-axis decomposition** — **ANSWERED** | 200/189 = p₁³p₃²/(p₂³p₄) confirmed as S¹ mechanism, not per-ℓ damping (NB187). NB192: per-prime Chebyshev coupling formulas derived analytically. | **ANSWERED**. 200/189 is an algebraic bridge between two equivalent factorizations of x_q = 100/63: cascade view (4/7)(25/9) and S² view (3/2)(200/189). Not a per-prime geometric quantity — systematic search across all C_T_p(l,l';0) entries, products, ratios yields no match. The per-axis structure is encoded in the Chebyshev coupling formulas, and 200/189 connects their two perspectives. | — |
...
**Priority**: GD-1 is COMPLETE (NB190+NB191). GD-3 is ANSWERED (NB192: 200/189 = algebraic bridge, not geometric). GD-2 (C₀) is the highest-value target — C₀ does NOT come from cross-l coupling (NB191 closes this). GD-5 (full 4D Laplacian) builds on the NB190 action.
